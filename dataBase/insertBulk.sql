...
INSERT INTO PRODUCTO (nombre, descripcion, precio, marca, id_categoria, imagen)
VALUES
('Destornillador Philips Truper', 'Destornillador de punta Philips, mango ergonómico', 1200, 'Truper', 1, 'destornillador_philips_truper.jpg'),
('Serrucho Bahco 2600-XT', 'Serrucho profesional de 22 pulgadas, hoja templada', 5400, 'Bahco', 1, 'serrucho_bahco_2600xt.jpg'),
('Multímetro Digital Fluke 101', 'Multímetro compacto ideal para tareas básicas de medición', 15500, 'Fluke', 2, 'multimetro_fluke_101.jpg'),
('Lámpara LED OSRAM 10W', 'Lámpara LED de bajo consumo, luz cálida, 10W', 1800, 'OSRAM', 7, 'lampara_led_osram_10w.jpg'),
('Guantes de Seguridad 3M', 'Guantes anticorte nivel 5 para trabajos pesados', 2500, '3M', 6, 'guantes_seguridad_3m.jpg'),
('Martillo Demoledor Bosch GSH 11E', 'Martillo demoledor profesional de 1500W', 235000, 'Bosch', 2, 'martillo_demoledor_bosch.jpg'),
('Cemento Portland 25kg', 'Saco de cemento Portland de 25kg', 3900, 'Cemex', 3, 'cemento_portland_25kg.jpg'),
('Cable Eléctrico 2x1.5mm', 'Cable de cobre dúplex para instalaciones eléctricas', 1800, 'Nexans', 5, 'cable_electrico_2x1.5.jpg'),
('Silla Plegable Plástica', 'Silla liviana para jardín o exterior', 7500, 'GardenLife', 8, 'silla_plegable_plastica.jpg'),
('Barreta de Acero 60cm', 'Barreta recta de acero templado para demolición', 6700, 'Truper', 1, 'barreta_acero_60cm.jpg'),
('Tornillos Drywall 1"', 'Caja con 1000 tornillos para drywall', 2800, 'Senco', 8, 'tornillos_drywall_1pulgada.jpg'),
('Panel LED 60x60cm', 'Panel LED empotrable para cielo falso', 15800, 'Philips', 7, 'panel_led_60x60.jpg'),
('Llave Stilson 14"', 'Llave para tubos con mandíbula ajustable', 9600, 'Ridgid', 1, 'llave_stilson_14.jpg'),
('Pintura Látex Blanca 1 Galón', 'Pintura base agua para interiores', 9200, 'Sherwin-Williams', 4, 'pintura_latex_blanca.jpg'),
('Extensión Eléctrica 5m', 'Cable alargador con 3 tomas', 3600, 'PowerSafe', 5, 'extension_5m_powersafe.jpg'),
('Cinta Aislante 3M', 'Rollo de cinta aislante negra', 500, '3M', 5, 'cinta_aislante_3m.jpg'),
('Pulidora Angular Makita 9557NB', 'Pulidora de 115mm y 840W de potencia', 42000, 'Makita', 2, 'pulidora_makita.jpg'),
('Escalera Aluminio 6 Peldaños', 'Escalera plegable para trabajo doméstico', 28000, 'HomePro', 8, 'escalera_aluminio_6peldaños.jpg'),
('Rollo de Malla Acma 1x10m', 'Malla galvanizada para construcción', 9100, 'Construmet', 3, 'malla_acma_1x10m.jpg'),
('Casco de Seguridad Amarillo', 'Casco con suspensión interna y ajuste automático', 3900, 'SafetyPro', 6, 'casco_seguridad_amarillo.jpg');
...
INSERT INTO inventario (id_producto, id_sucursal, stock) VALUES
(11, 1, 50), (11, 2, 20), (11, 3, 15),
(12, 1, 40), (13, 2, 60), (14, 3, 90),
(15, 2, 110), (16, 3, 25), (17, 1, 100),
(18, 1, 80), (19, 2, 40), (20, 2, 120),
(21, 1, 300), (22, 3, 35), (23, 3, 55),
(24, 2, 10), (25, 3, 30), (26, 1, 45),
(27, 2, 60), (28, 3, 20), (29, 1, 70),
(30, 2, 150);
...
INSERT INTO pedido (fecha, estado, total, rutcliente, id_estadopedido, id_sucursal) VALUES
('2025-04-11', 'En Proceso', 28000, '56789012-3', 1, 1),
('2025-04-12', 'Enviado', 34000, '89012345-6', 2, 2),
('2025-04-13', 'Entregado', 39000, '90123456-7', 3, 3),
('2025-04-14', 'En Proceso', 46000, '56789012-3', 1, 1),
('2025-04-15', 'Enviado', 51000, '89012345-6', 2, 2),
('2025-04-16', 'Entregado', 38000, '90123456-7', 3, 3),
('2025-04-17', 'En Proceso', 60000, '56789012-3', 1, 1),
('2025-04-18', 'Enviado', 43000, '89012345-6', 2, 2),
('2025-04-19', 'Entregado', 47000, '90123456-7', 3, 3),
('2025-04-20', 'En Proceso', 52000, '56789012-3', 1, 1);
...
INSERT INTO transaccion (fecha, monto, id_pedido, id_metodo_pago) VALUES
('2025-04-11', 28000, 16, 1),
('2025-04-12', 34000, 17, 2),
('2025-04-13', 39000, 18, 3),
('2025-04-14', 46000, 19, 1),
('2025-04-15', 51000, 20, 2),
('2025-04-16', 38000, 21, 3),
('2025-04-17', 60000, 1, 1),
('2025-04-18', 43000, 2, 2),
('2025-04-19', 47000, 3, 3),
('2025-04-20', 52000, 4, 1);

INSERT INTO Transferencia (monto, fecha, id_pedido, comprobante, comentario, idEstadoTrnsf) VALUES
(34000, '2025-04-12', 17, 'comprobante_transferencia_9.pdf', 'Pago transferencia pedido 17', 1),
(51000, '2025-04-15', 20, 'comprobante_transferencia_10.pdf', 'Pago transferencia pedido 20', 1),
(43000, '2025-04-18', 22, 'comprobante_transferencia_11.pdf', 'Pago transferencia pedido 22', 1);
